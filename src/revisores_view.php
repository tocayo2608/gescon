...
<p>
    <a href="/gescon/src/router.php?page=revisor_crear" class="btn btn-sm btn-success">
        + Agregar revisor
    </a>
</p>
    ...
    <table class="table table-striped table-sm">
        ...
        <?php foreach ($revisores as $r): ?>
            <tr>
                ...
                <td>
                    <a href="/gescon/src/router.php?page=revisor_editar&id=<?= $r['id_usuario'] ?>"
                       class="btn btn-sm btn-outline-primary">Editar</a>
                    <a href="/gescon/src/router.php?page=revisor_eliminar&id=<?= $r['id_usuario'] ?>"
