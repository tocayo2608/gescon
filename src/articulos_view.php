...
<form method="get" action="/gescon/src/router.php">
    ...
    <?php if (!empty($busqueda)): ?>
        <a href="/gescon/src/router.php?page=articulos">Limpiar</a>
    <?php endif; ?>
</form>
<br>
    ...
    <table border="1" cellpadding="6">
        ...
        <?php foreach ($articulos as $art): ?>
            <tr>
                ...
                <td>
                    <a href="/gescon/src/router.php?page=articulo_editar&id=<?= $art['id_articulo'] ?>">
                ...
                <td>
                    <?php if ($art['estado'] !== 'Eliminado'): ?>
                        <a href="/gescon/src/router.php?page=articulo_editar&id=<?= $art['id_articulo'] ?>">Editar</a>
                        |
                        <a href="/gescon/src/router.php?page=articulo_borrar&id=<?= $art['id_articulo'] ?>"
